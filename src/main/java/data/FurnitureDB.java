...
public class FurnitureDB {
    ...
    public static List<Feedback> getFeedBacks (int page, int pageSize){
        EntityManager em = DBUtil.getEmFactory().createEntityManager();
        ...
        q.setFirstResult((page - 1) * pageSize);  // bat dau tu dong thu bao nhieu
        q.setMaxResults(pageSize);  // so dong tren moi trang
    ...
    public static long countFeedBacks (){
        EntityManager em = DBUtil.getEmFactory().createEntityManager();
        String qString = "SELECT COUNT(fe) FROM Feedback fe";
